...
<!--//////////////////////Home Section/////////////////////////// */
/* //////////////////////Home Section/////////////////////////// */ -->
<section class="header-404" id="header-404">
    <div class=" container-fluid">
        <div class="row justify-content-center align-items-center">
            <div class="col-md-12 col-sm-12 text-center welcomeText">
                <h1 class="">oops!</h1>
                <h3>this food is not for you</h3>
                <span class="pages-header-span"> <a class="text-light" href="{{route('web.home')}}"> <i class=" fas fa-home mr-2"></i> / HOME </a>

              <h1>
                <span>4</span>
                <span><img class="d-inline-block error-img" src="/assets/photos/imgs/404-o-4.png" width="250px" height="250px"  alt=""></span>
                <span>3</span>
              </h1>
              <h3 class="">
                <span class="d-inline-block">
                  <h4 class="text-uppercase">error 403</h4>
                  <p class="d-inline-block bracket-text">this page you looking for is dosent exist.
                     <br> go to <a href="{{route('web.home')}}"> <i class="fa fa-home"></i>  home</a> page and try again </p>
                </span>
              </h3>
            </div>
        </div>
