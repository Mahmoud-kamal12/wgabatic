        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse ml-auto" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a href="{{route('web.contact')}}" class="nav-link activelink ">Contact us</a></li>
        ...
        <div class="container">
            <div class="row justify-content-center align-items-center">
                <div class="col-md-12 col-sm-12 text-center welcomeTexte">
                    ...
                    </span> <span class=" text-danger ml-3 text-uppercase">  contact us </span>
                </div>
            </div>
        </div>
    </div>
...
<section class="contact-form">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 mt-5 form-container pt-5 pb-5">
                <div class="text-center ">
                    <h1 class="text-capitalize">Send Your Message</h1>
                    <img src="/assets/photos/new2/seperator.png" width="250px" alt="">
                    <h5 class="col-lg-9 text-center m-auto">Don’t hestiate to ask us something, Our customer support team always ready to help
                        you,they will support you 24/7.</h5>
                </div>
                <form class="contact-form mt-5 col-lg-8 text-center m-auto" >
                    <!-- ////////////////////////// -->
                    <div class=" mt-5 ">
                        <div class="col-md-12 p-1   ">
                            <input type="text" class="p-2 col-lg-12 p-2" id="validationCustom" value="" required placeholder="Your Name*">
                        </div>
                        <div class="col-md-12 p-1 ">
                            <input type="email" class="p-2 col-lg-12 p-2 " id="validationCustom" value="" required placeholder="Your Email*">
                        </div>
                        <div class="col-md-12 p-1 ">
                            <textarea class="col-lg-12 p-2 " name="" id="" cols="20" rows="5"></textarea>
                        </div>
                    </div>
                    <!-- ////////////////////////////////////////// -->

                    <div class="inner-butn"> <button class="btn btn-danger submit-btun  p-1 col-lg-2 p-2 col-md-6 col-sm-6 mb-3" type="submit">  Submit </button> </div>
                </form>
            </div>
        </div>
    </div>
...
<!-- ///////////////////////////////////////////////////////////////////////// -->
<!-- ///////////////////////////////////////////////////////////////////////// -->
<section class="w-100 mt-5 p-0 m-0">
    <div class=" p-0 m-0 container-fluid w-100">
        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3445.2638823427264!2d31.7376614!3d30.2865485!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1457fdc719858575%3A0x5ea93cf0cea65166!2sHigher%20Technological%20Institute!5e0!3m2!1sen!2seg!4v1611352222954!5m2!1sen!2seg"  height="450" frameborder="0"
...
<footer class="  m-0 pt-4 section footer-classic context-dark bg-image p-5">
