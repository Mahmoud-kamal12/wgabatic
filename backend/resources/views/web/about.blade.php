...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/pagesStyle.css">
  ...
  <div class="preloader d-flex align-items-center justify-content-center">
      <div class="preloader-inner position-relative">
          ...
          <div class="preloader-img pere-text ">
              <img src="../photos/new/preloader.gif" alt="loader">
          </div>
      </div>
  </div>
</div> -->
...
<!--//////////////////////Home Section/////////////////////////// */
/* //////////////////////Home Section/////////////////////////// */ -->
<section class="about-page-header " id="about-page-header  ">
    <div class="">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse ml-auto" id="ftco-nav">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item"><a href="{{route('web.about')}}" class="nav-link activelink">about us</a></li>
                        <li class="nav-item"><a href="{{route('web.howItWork')}}" class="nav-link ">How It Works</a></li>
        ...
        <div>
            <div class="container">
                <div class="row justify-content-center align-items-center">
                    ...
                    </span> <span class=" text-danger ml-3">  ABOUT US </span>
                    </div>
                </div>
            </div>
        </div>
...
<!-- <div class="about-bursh-img">
  <img class="img-fluid img-responsive" src="../photos/imgs/brush_bg.png " width="100%" height="400px" alt="">
</div> -->
<div class="about-img-circle text-center">
    <img class="img-fluid img-responsive" src="/assets/photos/imgs/image1.png " width="300px" height="300px" alt="">
</div>
<!-- ///////////////////////////////////////////////////////////////////////// -->
<!-- ///////////////////////////////////////////////////////////////////////// -->
<!-- ///////////////////////////////////////////////////////////////////////// -->
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-7 pl-5  about-text-about">
                ...
                <!--Accordion wrapper-->
                <div class=" col-lg-10 accordion md-accordion accordion-blocks" id="accordionEx78" role="tablist" aria-multiselectable="true">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header" role="tab" id="headingUnfiled">
                            ...
                            <a data-toggle="collapse" data-parent="#accordionEx78" href="#collapseUnfiled" aria-expanded="true"
                               aria-controls="collapseUnfiled">
                                <h5 class="mt-1 mb-0">
                                    <span class="text-danger">our vision</span>
                        ...
                        <!-- Card body -->
                        <div id="collapseUnfiled" class="collapse show" role="tabpanel" aria-labelledby="headingUnfiled"
                        ...
                        <div class="card-header" role="tab" id="heading79">
                            ...
                            <a data-toggle="collapse" data-parent="#accordionEx78" href="#collapse79" aria-expanded="true"
                               aria-controls="collapse79">
                                <h5 class="mt-1 mb-0">
                                    <span class="text-danger " >our mission</span>
                                    <i class="text-danger fas fa-angle-down rotate-icon"></i>
                                </h5>
                            </a>
                        ...
                        <div class="card-header" role="tab" id="heading80">
                            ...
                            <a data-toggle="collapse" data-parent="#accordionEx78" href="#collapse80" aria-expanded="true"
                               aria-controls="collapse80">
                                <h5 class="mt-1 mb-0">
                                    <span class="text-danger ">our value</span>
                                    <i class="text-danger fas fa-angle-down rotate-icon"></i>
                                </h5>
                            </a>
                        </div>
            ...
            <!-- //////////////// -->
            <!-- //////////////// -->
            <div class="col-lg-5 p-2 about-img-pages mt-3">
        ...
        <div class="row p-0 m-0">
            ...
            <div style="background-color: #284159;" class="col-lg-3 col-md-6 col-sm-12 team-data team-data1">
                ...
                <div class=" text-right">
                    <i class=" text-light fa fa-long-arrow-alt-right "></i>
                </div>
            </div>
            <!-- ///////////////////////////// -->
            ...
            <div style="  background-color: #849cd6;" class="col-lg-3 col-md-6 col-sm-12 team-data team-data3">
                ...
                <div class=" text-left">
                    <i class=" text-light fa fa-long-arrow-alt-left "></i>
                </div>
            </div>
            <!-- ///////////////////////////// -->
            <!-- ///////////////////////////// -->
...
<div class="text-center">
    <img  src="/assets/photos/divider.png" alt="">
    <h1 class="text-center  text-title">    customers testemonials </h1>
    <p>our customers says </p>
</div>
<br>
<!-- Testimonial Slider Section -->
<img style="position: relative; top: 70px;" class="img-fluid img-responsive teste-white-buuble-top" src="/assets/photos/team/customer-top-bg.png" alt="">
                    ...
                    <div class="carousel-inner" role="listbox">
                        ...
                        <div class="carousel-item active">
                            <div class="carousel-content">
                                <div class="client-img"><img src="/assets/photos/team/luay-face-res.png" alt="Testimonial Slider"></div>
                                <h3>luay khaled <br><span>egypt</span></h3>
                                <div class="">
                                    <i style="top: 180px; right: 100px;" class=" text-warning fa fa-star "></i>
                                    <i style="top: 180px; right: 80px; " class=" text-warning fa fa-star "></i>
                                    <i style="top: 180px; right: 60px; " class=" text-warning fa fa-star "></i>
                                    <i style="top: 180px; right: 40px; " class=" text-warning fa fa-star "></i>
                                    <i style="top: 180px; right: 20px; " class=" text-warning fa fa-star-half-alt "></i>
                                </div>
                        ...
                        <div class="carousel-item">
                            <div class="carousel-content">
                                <div class="client-img"><img src="/assets/photos/team/menia.jpg" alt="Testimonial Slider"></div>
                                <h3>mohamed menia  <br><span>egypt</span></h3>
                                <div class="">
                                    <i style="top: 180px; right: 100px;" class=" text-warning fa fa-star "></i>
                                    <i style="top: 180px; right: 80px; " class=" text-warning fa fa-star "></i>
                                    <i style="top: 180px; right: 60px; " class=" text-warning fa fa-star "></i>
                        ...
                        <div class="carousel-item">
                            <div class="carousel-content">
                                <div class="client-img"><img src="/assets/photos/team/darsh-face.jpg" alt="Testimonial Slider"></div>
                                <h3>mostafa emad <br><span>egypt</span></h3>
                                <div class="">
                                    <i style="top: 180px; right: 100px;" class=" text-warning fa fa-star "></i>
                                    <i style="top: 180px; right: 80px; " class=" text-warning fa fa-star "></i>
                                    <i style="top: 180px; right: 60px; " class=" text-warning fa fa-star "></i>
...
<img style="position: relative; bottom: 70px;" class="img-fluid img-responsive teste-white-buuble-bootom" src="/assets/photos/team/customer-bottom-bg.png" alt="">
...
<section class="doc-photo">
    ...
    <div style="z-index: 1111;" class="element">
